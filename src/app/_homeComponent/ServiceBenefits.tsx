...
export const ServiceBenefits: React.FC = () => {
  return (
    <section className="flex flex-col justify-center items-center px-16 py-24 mt-2.5 w-full text-center bg-zinc-100 max-md:px-5 max-md:max-w-full">
      <div className="flex gap-5 justify-between items-start w-full max-w-[1141px] max-md:flex-col max-md:max-w-full">
        {/* 1st Block */}
        ...
        {/* Divider */}
        <div className="self-stretch w-[1px] bg-[#80808030] max-md:hidden" />
